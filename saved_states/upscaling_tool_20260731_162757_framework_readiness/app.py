...
STATIC_ROUTES = {
    "/style.css": (_read_static("style.css"), "text/css; charset=utf-8"),
    "/app.js": (_read_static("app.js"), "application/javascript; charset=utf-8"),
}
...
class AppHandler(BaseHTTPRequestHandler):
    def _resolve(self):
        ...
        if self.path in STATIC_ROUTES:
            text, content_type = STATIC_ROUTES[self.path]
