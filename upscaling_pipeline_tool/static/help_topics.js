  ...
  const topics = {
    ...
    board: {
      ...
      items: [
        ...
        { title: "Focusing the map", body: "Use the focus control in the map toolbar to hide both side panels and fit the network to the wider canvas. Press it again to restore the protocol and inspector panels." },
